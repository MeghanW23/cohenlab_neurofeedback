...
FIX_LOCATION_SECMON_WIDTH_DIVISOR: float = 1.9
FIX_LOCATION_SECMON_HEIGHT_DIVISOR: float = 2.1
...
BUZZ_BEAR_LOCATION_SECMON_WIDTH_DIVISOR: float = 1.9
BUZZ_BEAR_LOCATION_SECMON_HEIGHT_DIVISOR: float = 2.1
