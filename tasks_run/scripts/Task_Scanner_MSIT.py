...
# This is an MSIT Task built with Pygame that uses a random fixed seed to create a pseudorandom order for each block type, whether control or interference. This script has calls for the seeds to be presented PRE task.
