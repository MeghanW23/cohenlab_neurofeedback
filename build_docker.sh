...
scripts=("startup_docker.sh" "get_ssh_keys.sh" "make_venv.sh" "tasks_run/scripts/RegisterFnirt.sh" "tasks_run/scripts/TransferFilesE3.sh" "tasks_run/scripts/PreprocRegisterE3.sh")
