...
- **setup_main_docker**: Contains source material related to the creation of the Docker image. The docker images used for this project can be found [here](https://hub.docker.com/u/meghanwalsh). This directory includes:
